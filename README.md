...
- El microservicio principal es Apache Kafka, que busca transacciones bancarias y se alimentan a un modelo para dar una predicción en tiempo real de fraude o no fraude.
