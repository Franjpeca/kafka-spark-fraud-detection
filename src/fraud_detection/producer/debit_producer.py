...
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s | debit_producer | %(levelname)s | %(message)s"
)
logger = logging.getLogger("debit_producer")
...
# Cargar esquema AVRO
# ============================================================
schema_path = Path(cfg["kafka"]["schema_registry"]["debit_schema"]).resolve()
...
# ============================================================
def produce_debit_message(message: dict):
    try:
        clean_message = {}
