...
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s | cash_out_producer | %(levelname)s | %(message)s"
)
logger = logging.getLogger("cash_out_producer")
...
# Cargar esquema AVRO
# ============================================================
schema_path = Path(cfg["kafka"]["schema_registry"]["cash_out_schema"]).resolve()
...
# ============================================================
def produce_cash_out_message(message: dict):
    try:
        clean_message = {}
